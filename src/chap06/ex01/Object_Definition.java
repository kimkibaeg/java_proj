...
public class Object_Definition {
	...
	// 생성자 : 클래스 이름과 동일하고 리턴 타입이 없는 메소드, 객체 생성 시 필드의 값을 초기화 할 때 사용
	...
	// 메소드 (함수) : 리턴타입 메소드명 (입력매개변수) {호출시 실행코드 ;}
	void printName() {
	...
	public static void main(String[] args) {
		/*
		 	절차적 지향 프로그래밍 (POP) : 시간의 순서에 따라서 프로그래밍, C
		 	 	...
		 	 	- 람보르기니, 페라리		<=== 고장 나면 그 회사에서만 수리, 수리비가 많이 나온다.
		 	 	- 한 회사에서 부품의 모든 것을 그 차에 맞게 최적화 시켜서 만듬.
		...
		System.out.println("=============================");
		// 1. 객체 생성 : 클래스는 (설계도, 붕어빵 틀) ===> 객체 (건물, 붕어빵)
