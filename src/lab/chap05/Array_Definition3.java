...
public class Array_Definition3 {
	public static void main(String[] args) {
		...
		/*
		 	1. 스캐너로 인풋 값을 받아서 배열의 방의 크기를 지정 하고 7의 배수와 8의 배수를 지정함.
		 	2. 스캐너로 인풋 값을 받아서 배열의 방의 크기를 지정 하고 1씩 증가하는데 4의 빼고 저장 후 출력
		 	3. 스캐너로 인풋 값을 받아서 배열의 방의 크기를 지정 하고 3의 배수는 저장하고 6의 배수는 빼고 저장 후 출력
		 */
		
		// 배열, 제어문 (for, do ~ while, 연산자(||, != (같지 않다.), == (같다))
...
//		public static void main(String[] args) {
			...
			do {
				...
				System.out.println("2. 스캐너로 인풋 값을 받아서 배열의 방의 크기를 지정 하고 1씩 증가하는데 4의 빼고 저장 후 출력");
				System.out.println("3. 스캐너로 인풋 값을 받아서 배열의 방의 크기를 지정 하고 3의 배수는 저장하고 6의 배수는 빼고 저장 후 출력");
...
//					for (int i = 0 ; i < arr.length ; i++) {
					...
					for ( int i = 0 ; ; a++) {		// 조건이 공백이면 무한루프
															// i = 방번호, a = 값 (7의 배수, 8의 배수)
						if(i == idx) {break;}
						
						if (a % 7 == 0 || a % 8 == 0) {   // a 가 7의 배수나 9의 배수일 때
							arr[i] = a ;					// arr[i]
					...
					for (int i = 0 ; i < arr.length ; a++ ) {
						...
						if (a % 4 == 0) { continue ; }  // a 변수의 값이 4의 배수일 때는 아래 내용을 실행 하지 않는다.
					...
					for (int i = 0; i < arr.length ; i ++) {
						System.out.println("방 번호 : " + i + ", 방의 값 : " + arr[i]);
					}
					...
					int a = 1;
					for (int i=0; i< arr.length; a++) {	// i : 방 번호는 값이 들어갔을 때만 방 번호가 늘어야 한다.
			...
			System.out.println("도달 할 수 없는 코드");
