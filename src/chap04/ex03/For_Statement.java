...
public class For_Statement {
	public static void main(String[] args) {
		...
		int a ;		// 블락 밖에서 선언 된 변수
//		for (a = 0 ; a >= 0 ; a++) {		// 조건이 계속 true (무한루프에 빠짐), 
		for (a = 0 ; a < 100 ; a++) {		
			System.out.println(a);
		}
		
		System.out.println("====================");
		// for 문 블락 밖에서 선언, for 블락 내에서 선언 (그 변수를 재사용 가능.(새로 사용 가능)
		for ( a = 10 ; a <= 100 ; a += 2) {
			System.out.println(a);
		}
...
//		System.out.println("마지막 i 변수의 값을 출력 : " + i);  // for 문 블락 내에서 초기화, 블락 밖에서는 오류 발생.
